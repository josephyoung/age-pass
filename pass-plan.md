...
写一个 bash 脚本 `$HOME/bin/pass`，用 `age` 加密代替 GPG，实现 `pass` 的核心子集。
...
- [ ] 9. REFACTOR：整理代码
- [ ] 10. 从 `.zshrc` 迁移现有 API Key 并加密存储
- [ ] 11. 清理 `.zshrc` 中的明文 API Key
